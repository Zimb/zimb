...
| Installation organisation bloquée (seul le bouton "Edit" apparaît) | Définir "Where can this GitHub App be installed?" sur "Any account" (ou transférer la propriété de l'App à l'organisation sous Advanced). L'utilisateur doit être Organization Owner ou GitHub App Manager. Détails: `docs/GITHUB_APP_ORG_INSTALLATION.md` |
